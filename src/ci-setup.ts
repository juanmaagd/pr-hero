...
# The secrets context is NOT readable in a job-level \`if\`, so credential
# presence is computed once here and consumed by the job condition below.
env:
  PRHERO_HAS_CREDS: \${{ secrets.ANTHROPIC_API_KEY != '' || secrets.CLAUDE_CODE_OAUTH_TOKEN != '' }}
