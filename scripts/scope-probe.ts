...
// Golden G2 = 1539@4609456d:96. Generous window: models cite the latch
// declaration, the setTimeout, or the dep array rather than one canonical line.
const GOLDEN_LINE = { min: 84, max: 108 };
...
const out = path.join(LAB, "bench", "probes", "scope-probe.json");
