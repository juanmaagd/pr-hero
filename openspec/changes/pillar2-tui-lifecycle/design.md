...
14. **Canonical repo constant:** one exported `juanmaagd/pr-hero` constant, pinned by a test, keeps the Releases API and identity-rendering surfaces from drifting from `README.md`/`install.sh`.
